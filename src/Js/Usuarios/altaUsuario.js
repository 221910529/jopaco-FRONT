    ...
    return (
      <div className="formulario">
        <div>
          ...
          <tbody>
            <tr>
              <td className="trmargen"><h4>Ingrese el campo Nombre</h4></td>
            </tr>
            <tr>
              <td><input className="inputs" type="text" name="Nombre" onChange={this.handleChange} /></td>
            </tr>
            <tr>
              <td className="trmargen"><h4>Ingrese el campo Apellido Paterno</h4></td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td className="trmargen"><h4>Ingrese el campo Apellido Materno</h4></td>
            </tr>
            <tr>
              <td>
                <input className="inputs"
            ...
            <tr>
              <td className="trmargen"><h4>Ingrese el campo Fecha de Nacimiento</h4></td>
            </tr>
            <tr>
              <td>
                <input className="inputs"
            ...
            <tr>
              <td className="trmargen"><h4>Ingrese el campo Correo Electronico</h4></td>
            </tr>
            <tr>
              <td><input className="inputs" type="text" name="Email" onChange={this.handleChange} /></td>
            </tr> 
            <tr>
              <td className="trmargen"><h4>Ingrese el campo Password</h4></td>
            </tr>
            <tr>
              <td><input className="inputs" type="text" name="Password" onChange={this.handleChange} /></td>
            </tr> 
            <tr>
              <td className="trmargen"><h4>Ingrese el campo Tipo de Usuario</h4></td>
            </tr>
            <tr>
              <td>
                <select  className="inputs" onChange={this.handleChange} name="Tipo_Usuario">
